...
import { useCreateTableMutation } from '@/queries/table.queries'
...
export default function AddTable() {
  ...
  return (
    <Dialog onOpenChange={(value) => {
      ...
      <DialogContent className='sm:max-w-[600px] max-h-screen overflow-auto' onCloseAutoFocus={() => form.reset()} aria-describedby={undefined}>
        <DialogHeader>
